  ...
  return (
    <Box>
      <Container display="flex" flexWrap="nowrap">
        <Box h="400px">
            <figure ref={box} className="c-blockimage c-lower-head01__image" style={{width: "1200px",height: "400px"}}>
        ...
        ="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 1420 467" style={{enableBackground:"new 0 0 1420 467"}} xmlSpace="preserve">
                <image xmlnsXlink="http://www.w3.org/1999/xlink" xlinkHref="http://road2code.oss-cn-hangzhou.aliyuncs.com/blog/151656.jpg" width="100%" height="100%" mask="url(#lower-image)"></image>
      ...
      <Script src="/assets/MorphSVGPlugin.js"  />
